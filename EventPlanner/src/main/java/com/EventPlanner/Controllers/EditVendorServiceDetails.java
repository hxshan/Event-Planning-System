...
public class EditVendorServiceDetails extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		UpdateVenderServiceDetails updateVenderServiceDetails = new UpdateVenderServiceDetails();
		
		String Servicename=request.getParameter("Servicename");
		String description=request.getParameter("description");
		BigDecimal price= new BigDecimal(request.getParameter("price"));
		
		updateVenderServiceDetails.UpdateVendorServices(ServiceId,VendorId,Servicename,description,price);
